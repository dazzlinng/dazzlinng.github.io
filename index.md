...
## 关于我 <span itemprop="name">段宇昊</span>
{: #about}

我是**段宇昊**，华南师范大学计算机科学与技术专业本科生（2023–2027）。目前跟随<a href="https://tempdb.scholat.com/haoty" target="_blank" class="highlight-link">郝天永教授</a>在<a href="https://tony-hao.github.io/TAMLab/index.html" target="_blank" class="highlight-link">文本分析与挖掘实验室</a>开展研究工作。
...
- **GPA 3.87/5.0** — 本科生优秀奖学金 (2024–2025)
- **IELTS 7.5** — 英语能力认证
- **CET-6: 535** — 大学英语六级
...
- **推理能力提升**：思维链（CoT）提示工程与复杂文档理解
- **数学建模应用**：微分方程建模与数值优化方法在AI系统中的应用
...
<div class="news-item">
  <span class="news-item__date">2025.07</span>
  <span class="news-item__content">
    苏州伟创电气设备技术有限公司研发助理实习（深圳），参与工业自动化系统开发与优化。
  </span>
</div>
...
<div class="project-section">
  <h3>药品标准智能解析与 Agent 知识引擎</h3>

  <div class="project-meta">
    2025.10 — 至今 | 合作单位：<a href="https://gdidc.gd.gov.cn/" target="_blank" class="highlight-link">广东省药检所 GDIDC</a> | 指导教师：<a href="https://tempdb.scholat.com/haoty" target="_blank" class="highlight-link">郝天永教授</a>
  </div>
...
| **大语言模型** | LLM 应用开发, RAG 系统, AI Agent, Prompt Engineering, 思维链推理 |
| **AI 框架与工具** | LangChain, Claude API, DeepSeek, Gemini, Hugging Face |
| **数学建模** | 微分方程建模, 数值优化, 系统仿真, MATLAB |
| **数据分析** | Pandas, NumPy, 数据可视化, 统计分析 |
| **开发工具** | Git/GitHub, VS Code, Jupyter, Linux |
...
[点击此处下载我的简历（PDF）](/assets/cv.pdf){:target="_blank"}
